      ...
      <div className="bg-white rounded-lg w-[80%] max-w-md p-6 relative">
        ...
        <div className="space-y-6">
          ...
          <div className="text-center border-b pb-4">
            <h3 className="text-2xl font-bold">{ticket.lottery_id.name}</h3>
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-between">
              ...
              <span>
                {format(
                  parse(ticket.lottery_id.draw_date, "d-M-yyyy", new Date()),
                  "dd-MM-yyyy"
                )}
              </span>
            </div>
            <div className="flex justify-between">
              ...
              <span>{format(ticket.purchase_date, "dd-MM-yyyy")}</span>
            </div>
