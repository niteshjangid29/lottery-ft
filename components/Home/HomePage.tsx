      ...
      if (typeof window !== "undefined" && "geolocation" in navigator) {
        navigator.geolocation.getCurrentPosition(
          (position) => {
            ...
            dispatch(fetchCityFromCoordinates({ latitude, longitude }));
          },
          () => {
            console.log(
          ...
          <div className="relative z-10">
            <div className="text-center">
              ...
              <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold mb-4 md:mb-6 px-4">
                {retailer ? retailer.brandName : "Win Big with Lotto G!"}
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center px-4">
                ...
                >
                  {authUser || authRetailer ? "Buy Tickets" : "Login"}
                </Link>
                {/* <Link
									href="/help"
        ...
        <div className="text-center mb-8 md:mb-10">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 px-4 gap-6 md:gap-8">
            {lotteries?.map((lottery: any) => (
              <LotteryCard lotteryData={lottery} key={lottery._id} />
            ))}
          </div>
        </div>
      </div>
              ...
              <div className="flex justify-center mb-3 md:mb-4">
                <stat.icon
                  className={`text-2xl md:text-4xl ${
                    retailer ? "text-[var(--primary-color)]" : "text-blue-600"
                  }`}
                />
              </div>
      ...
      <footer className="bg-gray-900 text-white pb-16 md:pb-0">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center sm:text-left">
              <h3 className="text-lg font-semibold mb-4">
                About {retailer ? retailer.brandName : "Lotto G"}
              </h3>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center">
            <p className="text-sm md:text-base text-gray-400">
              2023 {retailer ? retailer.brandName : "Lotto G"}. All rights
              reserved.
            </p>
          </div>
        </div>
