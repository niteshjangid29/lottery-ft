...
function PurchaseTicketsContent() {
  ...
  const { cartTickets, purchasedTickets: soldTickets } = useSelector(
  ...
  const addCustomTicket = () => {
    if (customNumber.length === lotteryDetails.digit_length) {
      if (selectedTickets.some((ticket) => ticket.number === customNumber)) {
  ...
  const handleCheckout = async () => {
    ...
    if (affiliate_id) {
      ...
      dispatch(
        ...
        .unwrap()
        .then((data) => {
          console.log("Affiliate Transaction created successfully", data);
        })
        .catch((error) => {
          console.error("Failed to create affiliate transaction", error);
        });
    }
      ...
      <div className="max-w-7xl mx-auto h-full p-4">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          ...
          <div className="flex gap-2 justify-between">
            <p className="text-gray-600 text-xs">
              Ticket Price:{" "}
              <span className="font-bold">₹ {lotteryDetails.ticket_price}</span>
            </p>
            <p className="text-gray-600 text-xs">
              Draw Date:{" "}
              <span className="font-bold">{lotteryDetails.draw_date}</span>
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden mb-6">
          <div className="flex border-b">
            ...
            >
              <FaPencilAlt className="inline mr-2" /> Choose your own number
            </button>
          </div>
            ...
            {activeTab === "random" ? (
              ...
              <div className="space-y-4">
                  ...
                  {Array.from(
                    ...
                    (_, i) => (
                      <NumberPicker
                        ...
                        totalDigits={lotteryDetails.digit_length}
                      />
                    )
                  )}
                </div>
                ...
                {suggestions.length > 0 && (
                  <div className="flex flex-col gap-2 justify-center items-center">
                    <p className="text-gray-600">
                      Ticket not available. Try these numbers:
                    </p>
                ...
                <button
                  ...
                  disabled={customNumber.length !== lotteryDetails.digit_length}
                >
                  Add Custom Ticket
                </button>
              </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <h2 className="text-2xl font-bold mb-4">Selected Tickets</h2>
