...
import { TICKETS_DATA } from "@/utils/data/TicketsData";
...
function DrawDetailsContent() {
	...
	const searchedTicket = TICKETS_DATA.find(
		(ticket) => ticket.number === searchTicket
	);
